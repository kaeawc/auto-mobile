...
object Navigation3Adapter : NavigationFrameworkAdapter {
  ...
  /**
   * Composable function to track navigation to a specific destination. Call this at the top of each
   * entry<> block in your NavDisplay.
   *
  ...
  /**
   * Manually track a navigation event without using Compose. Useful for tracking navigation in
