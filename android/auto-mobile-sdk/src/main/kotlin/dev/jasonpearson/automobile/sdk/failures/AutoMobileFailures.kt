 ...
 *
 * Handled exceptions are caught and recovered from by the app, but are still worth tracking for
 * debugging and monitoring purposes. They will appear in the Failures dashboard alongside crashes
 * and ANRs.
 *
 * Usage:
 * ```kotlin
