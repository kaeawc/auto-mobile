...
@Composable
fun CtrlProxyTheme(content: @Composable () -> Unit) {
...
fun ServiceStatusEnabledPreview() {
  CtrlProxyTheme { ServiceStatusDisplay(isServiceEnabled = true) }
}

@Preview(showBackground = true)
@Composable
fun ServiceStatusDisabledPreview() {
  CtrlProxyTheme { ServiceStatusDisplay(isServiceEnabled = false) }
}
