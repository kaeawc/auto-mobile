...
class MockFailuresDataSource(private val clock: Clock = SystemClock) : FailuresDataSource {
...
internal fun generateMockTimelineData(
  ...
  val buckets =
    (dateRange.durationMs / aggregation.durationMs).toInt().coerceIn(1, MAX_DISPLAYABLE_BUCKETS)
...
private fun formatRelativeTimeLabel(
  ...
  return when (aggregation) {
    ...
    TimeAggregation.Week -> {
      ...
      val daysToMonday =
        if (dayOfWeek == java.util.Calendar.SUNDAY) -6 else java.util.Calendar.MONDAY - dayOfWeek
...
internal fun createMockFailureGroups(clock: Clock = SystemClock): List<FailureGroup> {
  ...
  return listOf(
    ...
    FailureGroup(
      ...
      message =
        "java.lang.NullPointerException: Attempt to invoke virtual method 'String com.example.User.getName()' on a null object reference",
      ...
      stackTraceElements =
        listOf(
          StackTraceElement(
            "com.example.app.LoginViewModel",
            "validateUser",
            "LoginViewModel.kt",
            42,
            true,
    ...
    FailureGroup(
      ...
      message =
        "Application Not Responding: Main thread blocked for 5+ seconds during database query",
    ...
    FailureGroup(
      ...
      versionBreakdown = listOf(VersionBreakdown("2.4.1-debug", 5, 100f)),
      screenBreakdown =
        listOf(
      ...
      stackTraceElements =
        listOf(
          ...
          StackTraceElement(
            "com.example.app.MessageListAdapter",
            "onBindViewHolder",
