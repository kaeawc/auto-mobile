...
/**
 * Get fixed Y-axis range for a metric type. Returns Pair(minValue, maxValue) for consistent chart
 * scaling.
 */
...
/**
 * Convert a value to logarithmic scale for chart display. Maps values from [0, max] to [0, 1] using
 * log scale.
 */
