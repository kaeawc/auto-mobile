...
object SourceFileOpener {
  ...
  private fun resolveIde(setting: String, isIos: Boolean): Ide =
  ...
  private fun openInIde(ide: Ide, path: String, lineNumber: Int) {
    val commands: List<List<String>> =
      when (ide) {
        ...
        Ide.VSCode -> listOf(listOf("code", "--goto", "$path:$lineNumber"))
      }
