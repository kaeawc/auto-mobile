...
object TestMockData {
    ...
    val recentRuns = listOf(
        TestRun(
            ...
            durationMs = 4320,
            steps = listOf(
                TestStep("s1", 0, "launch", "com.chat.app", "screenshots/run1/step0_splash.png", "Splash", 800, TestStatus.Passed),
                TestStep("s2", 1, "wait", "Login screen", "screenshots/run1/step1_login.png", "Login", 1200, TestStatus.Passed),
                TestStep("s3", 2, "input", "Email field", "screenshots/run1/step2_email.png", "Login", 450, TestStatus.Passed),
                TestStep("s4", 3, "input", "Password field", "screenshots/run1/step3_password.png", "Login", 380, TestStatus.Passed),
                TestStep("s5", 4, "tap", "Login button", "screenshots/run1/step4_tap.png", "Login", 290, TestStatus.Passed),
                TestStep("s6", 5, "assert", "Home screen visible", "screenshots/run1/step5_home.png", "Home", 1200, TestStatus.Passed),
            ),
            screensVisited = listOf("Splash", "Login", "Home"),
            deviceId = "pixel8",
        ...
        TestRun(
            ...
            durationMs = 2890,
            steps = listOf(
                TestStep("s1", 0, "launch", "com.chat.app", "screenshots/run2/step0_splash.png", "Splash", 780, TestStatus.Passed),
                TestStep("s2", 1, "tap", "Create Account", "screenshots/run2/step1_login.png", "Login", 320, TestStatus.Passed),
                TestStep("s3", 2, "input", "Invalid email", "screenshots/run2/step2_signup.png", "Signup", 410, TestStatus.Passed),
                TestStep("s4", 3, "tap", "Sign Up button", "screenshots/run2/step3_tap.png", "Signup", 280, TestStatus.Passed),
                TestStep("s5", 4, "assert", "Error message visible", "screenshots/run2/step4_error.png", "Signup", 1100, TestStatus.Failed, "Expected error toast not found"),
            ),
            screensVisited = listOf("Splash", "Login", "Signup"),
        ...
        TestRun(
            ...
            durationMs = 11980,
            steps = listOf(
                TestStep("s1", 0, "launch", "com.chat.app", "screenshots/run3/step0_splash.png", "Splash", 820, TestStatus.Passed),
                TestStep("s2", 1, "wait", "Login screen", "screenshots/run3/step1_login.png", "Login", 1100, TestStatus.Passed),
                TestStep("s3", 2, "tap", "Skip login", "screenshots/run3/step2_skip.png", "Login", 280, TestStatus.Passed),
                TestStep("s4", 3, "tap", "Chats tab", "screenshots/run3/step3_home.png", "Home", 340, TestStatus.Passed),
                TestStep("s5", 4, "assert", "ChatList visible", "screenshots/run3/step4_chatlist.png", "ChatList", 890, TestStatus.Passed),
                TestStep("s6", 5, "tap", "Profile tab", "screenshots/run3/step5_profile_tap.png", "ChatList", 310, TestStatus.Passed),
                TestStep("s7", 6, "assert", "Profile visible", "screenshots/run3/step6_profile.png", "Profile", 920, TestStatus.Passed),
                TestStep("s8", 7, "tap", "Settings", "screenshots/run3/step7_settings_tap.png", "Profile", 290, TestStatus.Passed),
                TestStep("s9", 8, "assert", "Settings visible", "screenshots/run3/step8_settings.png", "Settings", 880, TestStatus.Passed),
            ),
            screensVisited = listOf("Splash", "Login", "Home", "ChatList", "Profile", "Settings"),
            deviceId = "pixel7",
