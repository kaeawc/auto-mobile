...
/**
 * IntelliJ Platform implementation of ValidationTrigger. Handles real-time validation updates with
 * minimal EDT usage.
 */
class IntellijValidationTrigger(private val project: Project) : ValidationTrigger {
