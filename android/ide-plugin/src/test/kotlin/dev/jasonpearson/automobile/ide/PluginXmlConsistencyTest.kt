 ...
 * serviceImplementation, implementationClass, listener class) points to a real class on the compile
 * classpath. Catches rename/delete regressions without needing to boot an IDE instance.
 */
