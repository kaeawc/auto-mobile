...
fun getIntroductionSlides(): List<SlideContent> =
  listOf(
    ...
    SlideContent.LargeText(title = "The best of mobile tooling has been inaccessible"),
    ...
    SlideContent.LargeText(title = "No cohesive UX ties them together"),
    SlideContent.Emoji(
      emoji = PresentationEmoji.SLOW,
      caption = "More like AutoCAD 2008",
    ),
    SlideContent.LargeText(title = "Automating tedium in mobile engineering has been out of reach"),
    SlideContent.LargeText(title = "I built AutoMobile to change that"),
    SlideContent.BulletPoints(
      title = "AutoMobile is:",
      points =
        listOf(
