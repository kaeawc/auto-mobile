...
fun getMobileUseSlides(): List<SlideContent> =
  listOf(
    ...
    SlideContent.LargeText(title = "What did web folks have that mobile didn't?"),
    SlideContent.BulletPoints(
    ...
    SlideContent.LargeText(title = "Solving UI testing tooling problems opens up full mobile use"),
  )
