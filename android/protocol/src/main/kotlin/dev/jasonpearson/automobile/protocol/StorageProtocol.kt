 ...
 *
 * These types provide type-safe communication between the AccessibilityService and the SDK's
 * SharedPreferencesInspectorProvider.
 *
...
sealed class StorageRequest {
  /** Check if SDK storage inspection is available and enabled. Method: "checkAvailability" */
  @Serializable @SerialName("check_availability") data object CheckAvailability : StorageRequest()

  /** List all SharedPreferences files in the app. Method: "listFiles" */
  @Serializable @SerialName("list_files") data object ListFiles : StorageRequest()

  /**
   * Get all key-value entries from a SharedPreferences file. Method: "getPreferences" Extras:
   * fileName (String)
   */
  @Serializable
   ...
   * (String), sinceSequence (Long, optional)
   */
  @Serializable
  ...
  @Serializable @SerialName("get_listened_files") data object GetListenedFiles : StorageRequest()

  /**
   * Get a single preference value by key. Method: "getPreference" Extras: fileName (String), key
   * (String)
   */
  @Serializable
  ...
  /**
   * Set a preference value. Method: "setValue" Extras: fileName (String), key (String), value
   * (String), type (String)
   */
  @Serializable
