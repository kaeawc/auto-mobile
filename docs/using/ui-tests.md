...
=== "Android"
    ...
    **Gradle**
    ...
    dependencies {
        testImplementation("dev.jasonpearson.auto-mobile:auto-mobile-junit-runner:0.0.75")
    }
    ```
...
=== "iOS"
    ...
    **Swift Package Manager**
    ...
    ```swift
    .package(url: "https://github.com/kaeawc/auto-mobile.git", from: "0.0.75")
    ```
...
```bash
export AUTOMOBILE_VERSION=0.0.75
bunx @kaeawc/auto-mobile@0.0.75 --daemon restart
bunx @kaeawc/auto-mobile@0.0.75 --cli doctor
```
