...
=== "Android"
    ...
    **Gradle**
    ...
    dependencies {
        testImplementation("dev.jasonpearson.auto-mobile:auto-mobile-junit-runner:0.0.74")
    }
    ```
...
=== "iOS"
    ...
    **Swift Package Manager**
    ...
    ```swift
    .package(url: "https://github.com/kaeawc/auto-mobile.git", from: "0.0.74")
    ```
...
```bash
export AUTOMOBILE_VERSION=0.0.74
bunx @kaeawc/auto-mobile@0.0.74 --daemon restart
bunx @kaeawc/auto-mobile@0.0.74 --cli doctor
```

Replace `0.0.74` with the version used by your test runner dependency.
