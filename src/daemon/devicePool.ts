...
type DevicePoolBootedDevice = BootedDevice & {
  simulatorType?: string;
  deviceType?: string;
};
...
export class DevicePool {
  ...
  private withDeviceImageMetadata(ready: BootedDevice, image: DeviceInfo): DevicePoolBootedDevice {
  ...
  private getBootedDeviceSimulatorType(device: BootedDevice): string | undefined {
