...
export const SCREEN_CAPTURE_HELPER_DOWNLOAD_TIMEOUT_MS = 2_000;

export const SCREEN_CAPTURE_HELPER_ARCHIVE_FILENAME = RELEASE_SCREEN_CAPTURE_HELPER_ARCHIVE_FILENAME;
  ...
  private async download(expected: string): Promise<string> {
    ...
    try {
      ...
      await fs.writeFile(
        ...
        } satisfies ScreenCaptureHelperMetadata, null, 2),
