...
//       expect(Array.isArray(runningEmulators)).toBe(true);
//
//       // Each emulator should have the required properties
//       runningEmulators.forEach(emulator => {
//         expect(emulator).toHaveProperty("name");
//         expect(emulator).toHaveProperty("isRunning");
//         expect(emulator).toHaveProperty("deviceId");
