 ...
 */
export class FakeCtrlProxyManager implements CtrlProxyManager {
  ...
  private mockDownloadApkPath: string = "/tmp/mock-control-proxy.apk";
  ...
  // Implementation of CtrlProxyManager interface
