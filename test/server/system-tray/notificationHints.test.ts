...
describe("nodeHasSystemTrayHint", () => {
  const cases: Array<[string, Record<string, unknown>, boolean]> = [
    ["matches systemui package + resource-id hint", { "packageName": SYSTEM_TRAY_PACKAGE, "resource-id": "notification_panel" }, true],
    ["matches systemui package + class hint", { packageName: SYSTEM_TRAY_PACKAGE, class: "NotificationShade" }, true],
    ["matches when resource-id embeds the systemui package", { "resource-id": `${SYSTEM_TRAY_PACKAGE}:id/qs_panel` }, true],
    ["rejects a systemui node with no matching hint", { "packageName": SYSTEM_TRAY_PACKAGE, "resource-id": "random_thing" }, false],
    ["rejects a hint from a non-systemui package", { "packageName": "com.example.app", "resource-id": "notification_panel" }, false],
...
describe("nodeHasIosNotificationCenterHint", () => {
  const cases: Array<[string, Record<string, unknown>, boolean]> = [
    ...
    ["matches via the ios-accessibility-label", { "ios-accessibility-label": "NotificationListCell" }, true],
