...
describe("IOSCtrlProxyManager", function () {
  ...
  describe("shutdownAll", function () {
    ...
    test("cancels a remote start before it records a runner after shutdown begins (#7093)", async function () {
      ...
      let pidWhenStopped: number | null | undefined;
      const remoteRunner = {
        isEnabled: () => true,
        ...
        stop: async () => {
          pidWhenStopped = (manager as unknown as { xcTestProcessId: number | null })
            .xcTestProcessId;
          return { success: true };
        },
      ...
      expect(pidWhenStopped).toBeNull();
